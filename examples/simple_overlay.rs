...
fn main() {
    ...
    use egui_overlay::{egui_window_glfw_passthrough::glfw, EguiOverlay};
    ...
    overlay
        .window_mut()
        .glfw
        .window_hint(glfw::WindowHint::Decorated(false));
    overlay
        .window_mut()
        .glfw
    ...
    overlay
        .window_mut()
        .glfw
        .window_hint(glfw::WindowHint::Resizable(false));

    // Set size and position (bottom-right corner)
    overlay.window_mut().set_size(300, 100);

    // Get screen size
    let (screen_width, screen_height) = overlay
        .window_mut()
        .glfw
                        ...
                        ui.vertical_centered(|ui| {
                            ...
                            match state {
                                ...
                                1 => {
                                    ...
                                    ui.add_space(8.0);
                                    ui.label(
                                        egui::RichText::new(format!("{:.1}s", elapsed % 3))
                                            .size(14.0),
                                    );
                                },
                                2 => {
                                ...
                                3 => {
                                    ...
                                    ui.add_space(5.0);
                                    ui.label(
                                        egui::RichText::new("\"Hello world\"").size(11.0).italics(),
                                    );
                                },
                                _ => {},
                            }
